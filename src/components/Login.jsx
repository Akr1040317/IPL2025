                  ...
                  <div className="flex flex-wrap items-center justify-between gap-1">
                    <label className="flex items-center">
                      <input
                        ...
                        id="remember"
                        name="remember"
                        className="size-4 rounded-sm border border-gray-200 text-[#f5a623] focus:border-[#f5a623] focus:ring-3 focus:ring-[#f5a623]/50 dark:border-gray-200/20 dark:bg-[#0d1a35] dark:ring-offset-[#0d1a35] dark:checked:border-transparent dark:checked:bg-[#f5a623] dark:checked:text-[#f5a623] dark:focus:border-[#f5a623] dark:focus:ring-offset-[#0d1a35]"
                      />
                    ...
                    <Link
                      to="#"
                      className="inline-block flex-none text-sm font-medium text-gray-600 hover:text-[#f5a623] dark:text-gray-200 dark:hover:text-[#f5a623]"
                    >
                      Forgot password?
                    </Link>
                  </div>
